...
function Restaurant(props) {
  ...
  let makePayment = async () => {
    ...
    let URL = "https://young-bayou-22921.herokuapp.com/api/payment";
    ...
    var options = {
      key: "rzp_test_TaMyucjGDfX1Wt",
      amount: order.amount,
      currency: "INR",
      name: "Zomato Clone Payment",
      description: "This is a food payment",
      image:
        "https://slickpos.com/wp-content/uploads/2018/08/zomato-logo.png",
      order_id: order.id,
      handler: async function (response) {
        let URL = "https://young-bayou-22921.herokuapp.com/api/callback";
        let sendData = {
  ...
  let getRestaurantDetails = async () => {
    let URL = "https://young-bayou-22921.herokuapp.com/api/get-restaurant-by-id/" + params.id;
    try {
  ...
  let getMenuList = async () => {
    let URL = "https://young-bayou-22921.herokuapp.com/api/get-menu-item?rid=" + params.id;
    try {
      let response = await axios.get(URL);
      let data = response.data;
      if (data.status === true) {
